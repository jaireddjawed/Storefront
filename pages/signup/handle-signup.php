<?php
  ...
  class CreateNewUser
  {
    ...
    public function register()
    {
      ...
      $insertUserStmt = '
        INSERT INTO `users` (first_name, last_name, email_address, customer_id, password, salt)
        VALUES (?, ?, ?, ?, ?, ?);
      ';
      $insertUserStmt = $this->connection->prepare($insertUserStmt);
      $insertUserStmt->bind_param('ssssss', $this->firstName, $this->lastName, $this->emailAddress, $customer['id'], $saltedPassword, $randomSalt);
